<x-layouts.app :pageTitle="__(':name\'s Schedule', ['name' => $child->name])">
    <style>
        ...
        .breadcrumb-link {
            ...
            font-size: 13px; color: var(--primary); text-decoration: none; margin-bottom: 8px;
        }
        .breadcrumb-link:hover { text-decoration: underline; }
        .breadcrumb-link svg { width: 14px; height: 14px; }
        .classroom-badge {
            display: inline-block; padding: 4px 14px; border-radius: 20px;
            background: var(--success-tint); color: var(--success-text); font-size: 12px; font-weight: 600; margin-top: 6px;
        }
